...
window.addEventListener('load', () => {
    ...
    const profileData = {
        ...
        bexperienceTitle: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(2) > div > div.display-flex.flex-column.full-width.align-self-center > div.display-flex.flex-row.justify-space-between > div > div > div > div > div > span:nth-child(1)')?.innerText || 'N/A',
        bexperienceCompany: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(2) > div > div.display-flex.flex-column.full-width.align-self-center > div.display-flex.flex-row.justify-space-between > div > span:nth-child(2) > span:nth-child(1)')?.innerText || 'N/A',
        bexperienceDescription: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(2) > div > div.display-flex.flex-column.full-width.align-self-center > div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg.pvs-entity__sub-components > ul > li:nth-child(1) > div > ul > li > div > div > div > div > span:nth-child(1)')?.innerText || 'N/A',
        oexperienceTitle: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(3) > div > div.display-flex.flex-column.full-width.align-self-center > div.display-flex.flex-row.justify-space-between > div > div > div > div > div > span:nth-child(1)')?.innerText || 'N/A',
        oexperienceCompany: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(3) > div > div.display-flex.flex-column.full-width.align-self-center > div.display-flex.flex-row.justify-space-between > div > span:nth-child(2) > span:nth-child(1)')?.innerText || 'N/A',
        oexperienceDescription: document.querySelector('div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg > ul > li:nth-child(3) > div > div.display-flex.flex-column.full-width.align-self-center > div.LDoSQiCJWinZRtzJNuiBVttBEmEsiuoLuAQhtg.pvs-entity__sub-components > ul > li:nth-child(2) > div > ul > li > div > div > div > div > span:nth-child(1)')?.innerText || 'N/A',
